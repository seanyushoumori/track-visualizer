...
- **Live readout while drawing.** A tooltip follows your cursor showing the in-progress track's **length**, **minimum curve radius** (red if tighter than the game's 29 m minimum), **max speed**, and **elevation** — all from the game's own values.
